                ...
                children: [
                  HeaderWidget(
                    ...
                    suffixWidget: CommonButton(
                      text: 'Blocked Users',
                      onTap: () {
                        NavigationController.navigateToDisabledUsersScreen(
    ...
    return Consumer(builder:
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          if ((index == 0 && userProvider.usersListLength == 0) ||
              (index == userProvider.usersListLength)) {
          ...
          MyTableCellModel(
            ...
            child: getTestEnableSwitch(
                ...
                onChanged: (val) {
                  ...
                  userController.EnableDisableUserInFirebase(
