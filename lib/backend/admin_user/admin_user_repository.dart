...
class AdminUserRepository {
  Future<AdminUserModel?> checkLoginAdminMethod(
    ...
    try {
      ...
      if (query.docs.isNotEmpty) {
        ...
        if (doc.data() is Map<String, dynamic>) {
          ...
          adminModel =
              AdminUserModel.fromMap(doc.data() as Map<String, dynamic>);
        }
      }
      ...
      MyPrint.printOnConsole(
          "Error in delete check admin login method in admin Repository $e");
      MyPrint.printOnConsole(s);
    }
    return null;
  }

  Future<void> addNewAdminToFirebase(
      {required AdminUserModel adminModel}) async {
    try {
