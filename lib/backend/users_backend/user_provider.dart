...
class UserProvider  extends ChangeNotifier {
  ...
  set setHasMoreDisabledUsers(bool hasMoreDisableUser) => _hasMoredisabledUsers = hasMoreDisableUser;
  ...
  DocumentSnapshot<Map<String, dynamic>>? get getDisabledUsersLastDocument => _disabledUserLastDocument;
  set setDisabledUsersLastDocument(DocumentSnapshot<Map<String, dynamic>>? documentSnapshot) => _disabledUserLastDocument = documentSnapshot;
  ...
  void updateEnableDisableDisabledOfList(bool value,int index,{bool isNotify = true}) {
